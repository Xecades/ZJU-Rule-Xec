...
Clash.Meta 使用 [`Clash/config/ZJU.ini`](Clash/config/ZJU.ini)。调用方需在合并订阅时为节点添加 `[YAHAGI]`、`[BBY]`、`[OKZ]`、`[ZJU]` 来源标记，为名称中含 `ZJU` 的节点添加 `📚` 前缀，并将公告类节点额外标记为 `[INFO]`。
